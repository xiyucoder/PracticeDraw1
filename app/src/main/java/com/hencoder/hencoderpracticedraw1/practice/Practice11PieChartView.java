...
public class Practice11PieChartView extends View {
    ...
    int blank = 20;
    {
        tableModels.add(new TableModel("Froyo",0.01, R.color.color_fro,0));
        tableModels.add(new TableModel("GB",0.05, R.color.color_gin,0));
        tableModels.add(new TableModel("ICS", 0.05, R.color.color_ice,0));
        tableModels.add(new TableModel("JB",0.6, R.color.color_jel,0));
        tableModels.add(new TableModel("KitKat",0.8, R.color.color_kit,0));
        tableModels.add(new TableModel("L", 0.9, R.color.color_lol,1));
        tableModels.add(new TableModel("M", 0.55, R.color.color_mar,0));
